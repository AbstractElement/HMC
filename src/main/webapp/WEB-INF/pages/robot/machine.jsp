...
<head>
  ...
  <title>HMC. ${machine.type} - ${machine.productId}</title>
            ...
            <ul>
              ...
              <li class="breadcrumb-item current">
                <a onclick="window.location.reload(true);">
                  <h1 class="h2 department-h1">${machine.type} - ${machine.productId}</h1>
                </a>
              </li>
            </ul>
          </li>
  ...
  <div id="single-product">
    <div class="container">
      ...
      <div class="no-margin col-xs-12 col-sm-7 body-holder">
        <div class="body">
          <div class="title">
            <a>${machine.type} - <span class="model${machine.productId}">${machine.model}</span></a>
          </div>
          <div class="brand">
            <big>
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="additional-info">
            <ul class="tabled-data">
              ...
              <li>
                <label><spring:message code="robot.condition"/></label>

                <div class="value">${machine.condition}</div>
              </li>
              <li>
                <label><spring:message code="robot.location"/></label>

                <div class="value">${machine.location}</div>
              </li>
              <li>
                <label><spring:message code="robot.axes"/></label>

                <div class="value">${machine.axes}</div>
              </li>
              <li>
                <label><spring:message code="robot.load"/></label>

                <div class="value">${machine.load}</div>
              </li>
              <li>
                <label><spring:message code="robot.reach"/>, <spring:message code="machine.mm"/></label>
                <div class="value">${machine.reach}</div>
              </li>
              <li>
                <label><spring:message code="robot.footprint"/></label>
                <div class="value">${machine.footprint}</div>
              </li>
              <li>
                <label><spring:message code="robot.repeatability"/>, Nm</label>
                <div class="value">${machine.repeatability}</div>
              </li>
              <li>
