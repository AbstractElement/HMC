        ...
        <div class="tabs box">
            ...
            <div class="box-content">
                ...
                <div id="gallery">
                    <div class="container-fluid">
                        <div class="row no-margin">
                            <c:forEach items="${imageListVmc}" var="image">
                                <div class="item col-xs-4 col-sm-2">
                                    <a href="/admin/galleryvmc/remove?image=${image}" class="ico ico-delete" style="float: left"></a>
                                    <img class="img-responsive" src="../resources/images/products/vmc/${image}" href="../resources/images/products/vmc/${image}"/>
                ...
                <div id="upload">
                    ...
                    <form class="formBox" method="post" action="galleryvmc/upload" enctype="multipart/form-data">

                        <fieldset>
                            <div class="clearfix file">
                                <div class="lab"><label for="imageFile">Upload images Vmc</label></div>
                                <div class="con">
                                    <input type="file" accept="image/*" name="imageVmc" class="upload-file"
