        ...
        <div class="tabs box">
            ...
            <div class="box-content">
                ...
                <div id="gallery">
                    <div class="container-fluid">
                        <div class="row no-margin">
                            <c:forEach items="${imageListLathes}" var="image">
                                <div class="item col-xs-4 col-sm-2">
                                    <a href="/admin/gallerylathes/remove?image=${image}" class="ico ico-delete" style="float: left"></a>
                                    <img class="img-responsive" src="../resources/images/products/lathes/${image}" href="../resources/images/products/lathes/${image}"/>
                ...
                <div id="upload">
                    ...
                    <form class="formBox" method="post" action="gallerylathes/upload" enctype="multipart/form-data">
